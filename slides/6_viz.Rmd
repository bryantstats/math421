...
```{r, message=FALSE}
df %>% ggplot()+
  geom_smooth(mapping = aes(x = positiveIncrease, 
                            y = deathIncrease, 
                            color = day_type))
```
...
---
```{r, message=FALSE}
df %>% filter(month >8, year==2020) %>% ggplot()+
  geom_smooth(mapping = aes(x = positiveIncrease, 
                            y = deathIncrease, 
                            color = day_type))
```
...
- [ggplot cheat sheet](https://raw.githubusercontent.com/rstudio/cheatsheets/main/data-visualization.pdf), or [backup](data-visualization.pdf)
