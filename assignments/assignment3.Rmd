...
If you do not have a data, you can use [the titanic dataset](https://www.kaggle.com/competitions/titanic/data?select=train.csv), which can be downloaded at [this link](../data/titanic.csv)
