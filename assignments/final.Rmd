...
- [Titanic](shiny_fa21/titanic.csv)
- [Adult Census](shiny_fa21/adult_modified.csv)
- [WHO Covid19](shiny_fa21/data/who_covid.csv)
...
7. Go to https://www.shinyapps.io/admin/#/dashboard.  Account -> Tokens -> Show -> Show secret-> Copy the secret code. 
