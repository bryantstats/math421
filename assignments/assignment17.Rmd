...
- Generate m = 10,000 samples from uniform distribution, each sample has the size $n = 1000$. Hint: Generate $m \times n$ random numbers and organize them in a matrix where each columns is a sample.  
